...
https://t.me/GintaSuperesse
 ...
 `2.txt` вписываем диапазон ip, можно через livetcpudpwatch и 2ip найти  
 `3.txt` айпи диапазоны исключения  
 `4.txt` сайты исключения  
 `5.txt` гугловские сайты, если с ними помогает отдельная стратегия  
 Четверг 4 4 4   
# Как настроить SecureDNS  
Параметры сети и интернета далее ethernet, там будут параметры DNS  
В качестве примера ставим вручную IPv4 предпочтительно 8.8.8.8   
DNS по протоколу HTTPS вкл, должно подобрать само  
Дополнительный 8.8.4.4 и также вкл.  
IPv6   
2001:4860:4860::8888 https вкл  
...
149.154.167.220 zws4-1.web.telegram.org127.0.0.1 genuine-software.autodesk.com  
