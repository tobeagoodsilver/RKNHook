...
--filter-tcp=443 --ipset="3.txt" --dpi-desync=split2 --dpi-desync-split-seqovl=652 --dpi-desync-split-pos=2 --dpi-desync-split-seqovl-pattern=\"%BIN%tls_clienthello_www_google_com.bin\"
